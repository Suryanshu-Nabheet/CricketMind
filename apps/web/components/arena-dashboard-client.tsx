      ...
      <header className="border-b border-border bg-background/80 backdrop-blur-md sticky top-0 z-50 px-6 py-4 flex items-center justify-between shrink-0">
        <div className="flex items-center gap-3 select-none">
          ...
          <img
            ...
            className="h-10 md:h-12 w-auto object-contain mx-2"
          />
          ...
          <div className="space-y-6 flex flex-col">
            ...
            {filteredMatches.length === 0 ? (
              ...
              <>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between border-t border-border/40 pt-6 mt-12 mb-6 text-xs md:text-sm text-muted-foreground select-none font-mono gap-4">
