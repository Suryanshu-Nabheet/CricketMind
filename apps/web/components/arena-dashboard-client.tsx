          ...
          <div className="flex-1 lg:overflow-hidden lg:flex lg:flex-col lg:min-h-0 space-y-6">
            ...
            {filteredMatches.length === 0 ? (
              ...
              <div className="flex-1 lg:overflow-y-auto pr-1 scrollbar-thin scrollbar-thumb-border">
                ...
                <div className="flex items-center justify-between border-t border-border/40 pt-6 mt-8 mb-4 text-[10px] text-muted-foreground select-none font-mono">
                  <span>Organized by Google Developer Groups</span>
